  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      images: {
        ...
        tasks: [
          /*'img:jpg', 'newer:pngmin:all', 'newer:svgmin'*/ "newer:copy:images",
        ],
        options: {
          spawn: false,
        },
    ...
    svg2string: {
      elements: {
        options: {
          template:
            '(window.SVG_SPRITES = window.SVG_SPRITES || {})["[%= filename %]"] = [%= content %];',
          wrapLines: false,
        },
        files: {
    ...
    csscomb: {
      ...
      dist: {
        ...
        files: {
          ...
          "<%= config.cssDir %>bootstrap.css":
            "<%= config.cssDir %>bootstrap.css",
          "<%= config.cssDir %>bootstrap-extended.css":
            "<%= config.cssDir %>bootstrap-extended.css",
        },
      },
    },
